...
class SubscriptionStorage(ABC):
    ...
    async def get_subscriptions(
        self, agent_id: str, event_type: Optional[str] = None, active_only: bool = True
...
class SlackService:
    def __init__(
        ...
        client: Optional['SlackHttpClient'] = None,
    ):
    ...
    async def post_to_subscribed_channels(
        ...
        for i, res in enumerate(results):
            ...
            if isinstance(res, dict) and res.get('success'):
                ...
                errors.append(
                    {'channel_id': sub.channel_id, 'error': err_msg or 'Unknown error'}
                )
...
class SlackBlockBuilder:
    ...
    def format_chat_response(
        message: str,
        citations: Optional[List[Dict[Any, Any]]] = None,
