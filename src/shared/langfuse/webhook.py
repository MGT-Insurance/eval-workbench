...
from shared.langfuse.prompt import LangfusePromptManager, get_langfuse_settings
from shared.slack.service import SlackBlockBuilder, SlackHttpClient, SlackService
...
async def _post_slack_alert(event_type: str, payload: Dict[str, Any]) -> None:
    ...
    message_options = SlackBlockBuilder.format_prompt_change_alert(
